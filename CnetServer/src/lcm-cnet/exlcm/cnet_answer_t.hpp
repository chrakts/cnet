...
#ifndef __exlcm_cnet_answer_t_hpp__
#define __exlcm_cnet_answer_t_hpp__
...
int cnet_answer_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int cnet_answer_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int cnet_answer_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t cnet_answer_t::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* cnet_answer_t::getTypeName()
{
    return "cnet_answer_t";
}

int cnet_answer_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int cnet_answer_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int cnet_answer_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
